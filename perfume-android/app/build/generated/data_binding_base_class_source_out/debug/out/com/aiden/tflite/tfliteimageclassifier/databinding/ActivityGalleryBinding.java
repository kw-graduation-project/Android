...
public final class ActivityGalleryBinding implements ViewBinding {
  ...
  private ActivityGalleryBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnSelectPhoto,
      @NonNull ImageView imageGallery, @NonNull TextView textResult) {
  ...
  public static ActivityGalleryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityGalleryBinding((ConstraintLayout) rootView, btnSelectPhoto, imageGallery,
          textResult);
    }
