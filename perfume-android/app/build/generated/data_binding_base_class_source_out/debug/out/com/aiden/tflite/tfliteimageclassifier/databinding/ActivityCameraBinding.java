...
public final class ActivityCameraBinding implements ViewBinding {
  ...
  private ActivityCameraBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnTakePhoto,
      @NonNull ImageView imagePhoto, @NonNull TextView textResult) {
  ...
  public static ActivityCameraBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCameraBinding((ConstraintLayout) rootView, btnTakePhoto, imagePhoto,
          textResult);
    }
