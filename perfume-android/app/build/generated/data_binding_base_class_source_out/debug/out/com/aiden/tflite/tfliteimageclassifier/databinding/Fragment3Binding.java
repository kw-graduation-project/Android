...
public final class Fragment3Binding implements ViewBinding {
  ...
  private Fragment3Binding(@NonNull ConstraintLayout rootView, @NonNull Button btnCamera,
  ...
  public static Fragment3Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new Fragment3Binding((ConstraintLayout) rootView, btnCamera, btnGallery);
    }
