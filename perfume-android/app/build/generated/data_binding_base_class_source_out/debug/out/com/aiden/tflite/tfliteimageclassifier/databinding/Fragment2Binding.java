...
public final class Fragment2Binding implements ViewBinding {
  ...
  private Fragment2Binding(@NonNull ConstraintLayout rootView, @NonNull Button delete,
      @NonNull ConstraintLayout fragment2, @NonNull TextView resultText,
  ...
  public static Fragment2Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new Fragment2Binding((ConstraintLayout) rootView, delete, fragment2, resultText,
          textView7);
    }
